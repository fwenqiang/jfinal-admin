 ...
 */
@ControllerBind(controllerKey = "/pintuan/app/myGrandChildTree")
public class MyGrandChildTreeController extends BaseProjectController {
	...
	public void index() throws CoreException {
	    ...
	    setAttr("usr_key_id", usr_key_id);
            render(path + "myGrandChildTree.html");
