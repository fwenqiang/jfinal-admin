...
public class BeanUtils {
	 ...
	 * @author zjh
	 */
	public static List<Map<String, Object>> toMaps(List<Object> objList) {
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		if (objList == null || objList.isEmpty())
			return list;
		try {
			for (int i = 0; i < objList.size(); i++) {
				list.add(toMap(objList.get(i)));
			}
	 ...
	 * @author zjh
	 */
	public static List<Map<String, Object>> toList(List<Record> objList) {
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		if (objList == null || objList.isEmpty())
			return list;
		try {
			for (int i = 0; i < objList.size(); i++) {
				list.add(objList.get(i).getColumns());
			}
		} catch (Exception e) {
			throw new RuntimeException("转换出错: " + e.getMessage());
		}
	 ...
	 * @author zjh
	 */
	/*public static void copyToObject(Map<String, Object> srcMap,BaseProjectModel object) {
