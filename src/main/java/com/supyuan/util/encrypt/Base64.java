...
public class Base64 {
	...
	public static String encodeAsString(String source) {
		if(source==null) throw new CoreException("001"," null can't be encoded");
		return new String(Base64.encodeBase64(source.getBytes()));
	}
	
	public static String decodeAsString(String source) {
		if(source==null) throw new CoreException("001"," null can't be decoded");
		return new String(Base64.decodeBase64(source.getBytes()));
	}
	
	public static void main(String[] args) {
		System.out.println(Base64.decodeAsString("a123456"));
	}
