...
public class RSAUtils {
	...
	/** 指定公钥存放文件 */
	public static String PUBLIC_KEY_FILE = PathUtils.getResPath()+"/RSAEncrypt/pub.txt";
	/** 指定私钥存放文件 */
	public static String PRIVATE_KEY_FILE =PathUtils.getResPath()+"/RSAEncrypt/pri.txt";
	...
	public static String encrypt(String source) throws Exception {
		System.out.println("encrypt="+PUBLIC_KEY_FILE);
		if(!FileUtils.isFile(PUBLIC_KEY_FILE)) {
		     generateKeyPair();
		}
		/** 将文件中的公钥对象读出 */
	...
	public static void main(String[] args) throws Exception {
		String source = "admin1233243244";// 要加密的字符串
		// 第一次使用
		...
		String key = "EBjYISsGR9GINn3rzCO7SZ+XcKLIFpGcRswsZgu0Wv/V5n12Q1RLIE/6cJ4ET4uK5qctx13bKcvaIT36CA0l/A==";
		String data = RSAUtils.decrypt((String)key);
