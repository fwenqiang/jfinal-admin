...
public class FileUtils {
	...
	public static void main(String[] args) throws IOException {
		System.out.println("1="+FileUtils.isFile("H:/pub.txt"));
		System.out.println("2="+FileUtils.isFile("H:/Youku Files"));
		System.out.println("3="+FileUtils.isFile("H:/pu234b.txt"));
