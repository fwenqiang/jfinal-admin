...
package com.supyuan.jfinal.component.util;
...
public class Attr {
	 ...
	 * 服务器文件名
	 */
	public static final String SRV_IMG_PATH = Config.getStr("ATTR.SRV_IMG_PATH");
	
	/**
	 * 服务器域名
	 */
	public static final String SRV_HOST = Config.getStr("ATTR.SRV_HOST");
}
